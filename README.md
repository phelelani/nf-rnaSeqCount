...
```bash
nextflow run nf-rnaSeqCount/main.nf -profile slurm --mode prep.Containers
```
...
```
nextflow run nf-rnaSeqCount/main.nf -profile slurm --mode prep.STARIndex 
```

- [x] Generate ```bowtie2``` indexes
```
nextflow run nf-rnaSeqCount/main.nf -profile slurm --mode prep.BowtieIndex
```
...
```bash
nextflow run nf-rnaSeqCount/main.nf -profile slurm --mode run.ReadQC
```
...
```bash
nextflow run nf-rnaSeqCount/main.nf -profile slurm --mode run.ReadTrimming
```
...
```bash
nextflow run nf-rnaSeqCount/main.nf -profile slurm --mode run.ReadAlignment
```
...
```bash
nextflow run nf-rnaSeqCount/main.nf -profile slurm --mode run.ReadCounting
```
...
```bash
nextflow run nf-rnaSeqCount/main.nf -profile slurm --mode run.MultiQC 
```
